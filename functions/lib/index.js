...
exports.assignUserRole = exports.processPaymentWebhook = exports.sendScheduledNotifications = exports.expirePendingVisitors = exports.onVisitorCreate = exports.api = void 0;
...
exports.api = functions.https.onRequest((0, app_1.createApp)());
// ==================== VISITOR FUNCTIONS ====================
/**
 ...
 */
exports.onVisitorCreate = functions.firestore
    ...
    try {
        ...
        const residentDocs = await Promise.all(residentUids.map((uid) => db.collection('users').doc(uid).get()));
        const fcmTokens = [];
        ...
        for (const doc of adminQuery.docs) {
            ...
            const shouldReceiveVisitorNotifications = userData.receiveVisitorNotifications !== false && // Default true
 ...
 */
exports.expirePendingVisitors = functions.pubsub
 ...
 */
exports.processPaymentWebhook = functions.https.onCall(async (data, context) => {
    if (!context.auth) {
...
exports.onVisitorCreate = exports.onVisitorCreate;
exports.expirePendingVisitors = exports.expirePendingVisitors;
exports.sendScheduledNotifications = exports.sendScheduledNotifications;
exports.processPaymentWebhook = exports.processPaymentWebhook;
exports.assignUserRole = exports.assignUserRole;
